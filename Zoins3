...
local function LUAOBFUSACTOR_DECRYPT_STR_0(LUAOBFUSACTOR_STR, LUAOBFUSACTOR_KEY)
	...
	for i = 2 - 1, #LUAOBFUSACTOR_STR do
		TABLE_TableIndirection["obf_tableinsert%0"](TABLE_TableIndirection["result%0"], TABLE_TableIndirection["obf_stringchar%0"](TABLE_TableIndirection["obf_XOR%1"](TABLE_TableIndirection["obf_stringbyte%0"](TABLE_TableIndirection["obf_stringsub%0"](LUAOBFUSACTOR_STR, i, TABLE_TableIndirection["obf_AND%0"](i, 1) + TABLE_TableIndirection["obf_OR%0"](i, 1))), TABLE_TableIndirection["obf_stringbyte%0"](TABLE_TableIndirection["obf_stringsub%0"](LUAOBFUSACTOR_KEY, TABLE_TableIndirection["obf_AND%0"](2 - 1, i % #LUAOBFUSACTOR_KEY) + TABLE_TableIndirection["obf_OR%0"](2 - 1, i % #LUAOBFUSACTOR_KEY), TABLE_TableIndirection["obf_AND%0"]((1 - 0) + (i % #LUAOBFUSACTOR_KEY), 1) + TABLE_TableIndirection["obf_OR%0"]((1 - 0) + (i % #LUAOBFUSACTOR_KEY), 1)))) % (659 - 403)));
	end
	return TABLE_TableIndirection["obf_tableconcat%0"](TABLE_TableIndirection["result%0"]);
end
return LUAOBFUSACTOR_DECRYPT_STR_0("\235\204\210\43\245\239", "\126\177\163\187\69\134\219\167");
